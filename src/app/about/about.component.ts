...
export class AboutComponent {
  ...
  public academic_activity: string = `VBCC Research  has jointly organized and supported more than 100 National / International Conferences so far. Few of them which have been recently held are mentioned below:`;
